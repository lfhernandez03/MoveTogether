...
const cambiarContraseniaController = require("../functions/cambiarContrasenia.cjs");
const cambiarContraseniaValidator = require("../middlewares/validacionesCambiarContrasenia.cjs");
