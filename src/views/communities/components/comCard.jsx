...
const ComCard = ({ imagenPerfil, nombre, administradorId, categorias, miembros, descripcion}) => {
  return (
      ...
      <div className="flex flex-col p-4 rounded-xl bg-white w-96 justify-center gap-4">
        ...
        <div className="flex py-4">
          {categorias.map((categoria) => (
            <div key={categoria} className="rounded-full bg-green-200 px-4 text-sm font-semibold">
              {categoria}
            </div>
          ))}
        </div>
